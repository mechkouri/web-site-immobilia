          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
              <ul class="navbar-nav ml-lg-5 mr-auto">
                  ...
                  <li class="nav-item @@listing__active">
                      <a class="nav-link" href="#locations">Listing</a>
                  </li>
                  <li class="nav-item @@listing__active">
...
<div class="col-lg-4 col-md-6 listing-img mt-lg-0 pt-lg-0 mt-5 pt-md-2">
                    <a href="#url">
                        <div class="box16">
                            ...
                            <img class="img-fluid" src="<?php echo $ligne['Photo'] ?>" alt="">
                            <div class="box-content">
                                <h3 class="title"><?php echo $ligne['Prix']; ?>  DH</h3>
                    ...
                    <div class="listing-details blog-details align-self">
                        <h4 class="user_title agent">
                            <a href="#url"><?php echo $ligne['Categorie']; ?></a>
                        </h4>
                        <p class="user_position"><?php echo $ligne['Adresse'];?></p>
                        <ul class="mt-3 estate-info">
                            <li><span class="fa fa-bars"></span> <?php echo $ligne['Etage']; ?> Etage</li>
                            <li><span class="fa fa-cube" ></span> <?php echo $ligne['Espace']; ?>m2</li>
                        </ul>
